            ...
            <div class="container w-50">
                ...
                <div class="mt-5">
                    ...
                    <div class="media-container-row mt-5">
                        <h4 class="text-end font-weight-light">Probability Analysis - Jacob</h2>
                    </div>
                    <div class="row">
                        <div class="col-sm">
                          <img class="img-fluid" src="./media/ProbabilityAnalysis.png"><i>A probability analysis example, by Jacob Kent</i></img>
                        </div>
                        <div class="col-sm">
